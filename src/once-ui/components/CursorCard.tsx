        ...
        {isHovering && !isTouchDevice && typeof document !== 'undefined' && createPortal(
          <Flex
            ...
            style={{
              isolation: "isolate",
              transform: `translate(
                calc(${mousePosition.x}px
                  ${placement.includes("left") ? "- 100%" : placement.includes("right") ? "" : placement.includes("start") ? "- 100%" : placement.includes("end") ? "" : "- 50%"}),
                calc(${mousePosition.y}px 
                  ${placement.includes("top") ? "- 100%" : placement.includes("bottom") ? "" : "- 50%"})
              )`,
              ...style,
            }}
            {...flex}
